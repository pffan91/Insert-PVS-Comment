...
namespace Insert_PVS_Comment
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class Insert_Comment_Student
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Insert_Comment_Student"/> class.
        /// Adds our command handlers for menu (commands must exist in the command table file)
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        private Insert_Comment_Student(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static Insert_Comment_Student Instance
        {
            get;
            private set;
        }
        ...
        {
            // Switch to the main thread - the call to AddCommand in Insert_Comment_Student's constructor requires
            // the UI thread.
            ...
            Instance = new Insert_Comment_Student(package, commandService);
        }
